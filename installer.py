...
def install(alsi):
    ...
    # If you need to use libyara outside of yara-python, you need to build Yara separately as shown:
    # local_yara_support = os.path.join(alsi.alroot, 'support/yara/')
    #
    # Build commands
    # local_yara = os.path.join(local_yara_support, 'yara-3.6.3.tar.gz')
    # alsi.fetch_package('yara-3.6.3.tar.gz', local_yara)
    #
    ...
    # alsi.runcmd("tar -zxf yara-3.6.3.tar.gz")
    # os.chdir(os.path.join(local_yara_support, "yara-3.6.3"))
    ...
    # alsi.fetch_package('yara-python-3.6.3.tar.gz', local_yara_python)
    #
    # os.chdir(local_yara_support)
    # alsi.runcmd("tar -zxf yara-python-3.6.3.tar.gz")
