...
By default, the tagcheck service runs a [small set of signatures](./rules/tagcheck.rules). Those rules are mainly geared toward dynamic analysis results analysis.
